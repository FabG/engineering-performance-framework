...
This framework is still a Work In Progress and all can help contribute to it.
It can be used to assess the performance of engineers on a regular basis (every 6
months). 
Much like the software we write, this framework will never be perfect or finished.
...
#### Resources
- [Guardian performance management framework](https://github.com/guardian/engineering-performance-framework/tree/main)